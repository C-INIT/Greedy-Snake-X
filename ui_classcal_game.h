/********************************************************************************
** Form generated from reading UI file 'classcal_game.ui'
**
...
#ifndef UI_CLASSCAL_GAME_H
#define UI_CLASSCAL_GAME_H
...
public:
    ...
    void setupUi(QWidget *Classcal_Game)
    {
        if (Classcal_Game->objectName().isEmpty())
            Classcal_Game->setObjectName(QString::fromUtf8("Classcal_Game"));
        Classcal_Game->resize(820, 620);
        Classcal_Game->setFocusPolicy(Qt::StrongFocus);
        Classcal_Game->setStyleSheet(QString::fromUtf8(""));
        verticalLayoutWidget = new QWidget(Classcal_Game);
        ...
        retranslateUi(Classcal_Game);

        QMetaObject::connectSlotsByName(Classcal_Game);
    } // setupUi

    void retranslateUi(QWidget *Classcal_Game)
    {
        Classcal_Game->setWindowTitle(QCoreApplication::translate("Classcal_Game", "Form", nullptr));
        Label->setText(QCoreApplication::translate("Classcal_Game", "\345\276\227\345\210\206", nullptr));
        Label_2->setText(QCoreApplication::translate("Classcal_Game", "\346\223\215\344\275\234\346\255\245\346\225\260", nullptr));
        Label_3->setText(QCoreApplication::translate("Classcal_Game", "\345\267\262\347\224\250\346\227\266\351\227\264", nullptr));
        StartButton->setText(QCoreApplication::translate("Classcal_Game", "\345\274\200\345\247\213", nullptr));
        RestartButton->setText(QCoreApplication::translate("Classcal_Game", "\351\207\215\346\226\260\345\274\200\345\247\213", nullptr));
        HelpButton->setText(QCoreApplication::translate("Classcal_Game", "\350\257\264\346\230\216", nullptr));
        SettingButton->setText(QCoreApplication::translate("Classcal_Game", "\350\256\276\347\275\256", nullptr));
        BackButton->setText(QCoreApplication::translate("Classcal_Game", "\350\277\224\345\233\236", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Classcal_Game: public Ui_Classcal_Game {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CLASSCAL_GAME_H
